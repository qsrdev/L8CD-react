...
const Checkout = () => {
  ...
  const validateForm = () => {
    ...
    if (!/^\S+@\S+\.\S+$/.test(formData.custom_email))
      errors.custom_email = true;
    if (!/^[a-zA-Z\s]+$/.test(formData.custom_name)) errors.custom_name = true;
    if (!/^[a-zA-Z\s]+$/.test(formData.custom_surname))
      errors.custom_surname = true;
              ...
              <div className="col-lg-7">
                ...
                >
                  ...
                  <button
                    ...
                    disabled={isSubmitting || (isFormTouched && !isFormValid)}
                  >
                    {isSubmitting ? (
